        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
                <div class="xl:flex xl:items-center xl:justify-start">
                    <img class="w-auto mx-auto h-12" src="./assets/images/nav-logo.png" alt="Footer Logo" />
    
                    <p class="mt-5 text-sm text-white xl:ml-6 xl:mt-0">© Copyright 2025 All Rights Reserved</p>
                </div>
                ...
                <div class="items-center mt-8 xl:mt-0 xl:flex xl:justify-end xl:space-x-8">
                    ...
                    <ul class="flex items-center justify-center space-x-8 xl:justify-end">
                        ...
                        <li>
                            <a href="https://www.instagram.com/globalcareercarnival/" title="" class="block text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
                                <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
