...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        ...
        <li>
            <a href="#whyattend" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Why Attend</a>
          </li>
        <li>
          <a href="#events" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Events</a>
        </li>
        ...
        <li>
            <a href="#faq" class="block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">FAQ</a>
        </li>
      </ul>
    </div>
    </div>
...
<section class="py-10 sm:py-16 lg:py-24">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="leading-tight text-black sm:text-4xl lg:text-2xl">The Global Career Carnival 2025 is a pioneering educational summit designed to provide:</h2>
        </div>
            ...
            <div class="grid grid-cols-1 gap-12 lg:gap-16 sm:grid-cols-2">
                <div class="flex items-start">
                    ...
                    <div class="ml-5">
                        ...
                        <p class="mt-4 text-base text-gray-600">Gain expert insights from industry leaders and career coaches to help you make informed decisions about your future.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-5">
                        <h3 class="text-lg font-semibold text-black">Interactive sessions on diverse career fields</h3>
                        <p class="mt-4 text-base text-gray-600">Explore career opportunities in technology, healthcare, business, arts, and more through engaging panel discussions and Q&A sessions.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-5">
                        ...
                        <p class="mt-4 text-base text-gray-600">Get personalized guidance from experienced professionals who can provide clarity and direction on your career path.</p>
                    </div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-5">
                        <h3 class="text-lg font-semibold text-black">Exhibitor stalls from leading institutions and industries</h3>
                        <p class="mt-4 text-base text-gray-600">Connect with top universities, training centers, and companies offering career programs, scholarships, and job opportunities.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="whyattend" class="py-10 bg-gray-50 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="max-w-xl mx-auto text-center">
                ...
                <p class="mt-4 text-base leading-relaxed text-gray-600">Discover career opportunities, gain expert insights, and connect with industry leaders at Global Career Carnival 2025. 🚀</p>
            </div>
    ...
    <section id="events" class="py-10 bg-gray-100 sm:py-16 lg:py-24">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto text-center">
                ...
                <p class="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">Explore a dynamic two-day schedule featuring expert talks, career guidance sessions, interactive workshops, and networking opportunities. 🚀</p>
            </div>
    ...
    <section id="registernow" class="py-10 bg-white sm:py-16 lg:py-24">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div class="max-w-2xl mx-auto text-center">
                ...
                <h2 class="mt-8 text-3xl font-bold leading-tight text-black lg:mt-12 sm:text-4xl lg:text-5xl"><span class="border-b-8 border-yellow-300">Register Now!</span></h2>
    ...
    <h2 class="text-2xl leading-tight text-black sm:text-2xl lg:text-3xl">Registration Form</h2>
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 text-left">
        ...
        <div class="col-span-full">
          <label for="school" class="block text-sm/6 font-medium text-gray-900">School / College</label>
          <div class="mt-2">
            <input type="text" name="school" id="school" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
          </div>
        </div>

        <div class="sm:col-span-3">
          <label for="guardian-name" class="block text-sm/6 font-medium text-gray-900">Guardian Name</label>
          <div class="mt-2">
            <input type="text" name="guardian-name" id="guardian-name" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
          </div>
        </div>

        <div class="sm:col-span-3">
          <label for="guardian-contact" class="block text-sm/6 font-medium text-gray-900">Guardian Contact</label>
          <div class="mt-2">
            <input type="text" name="guardian-contact" id="guardian-contact" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
          </div>
        </div>
                ...
                <div class="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                    ...
                    <div class="overflow-hidden bg-white rounded-xl">
                        <div class="p-6">
                            ...
                            <p class="mt-6 text-lg font-medium text-gray-900">drshakeeret@gmail.com</p>
                    ...
                    <div class="overflow-hidden bg-white rounded-xl">
                        <div class="p-6">
                            ...
                            <p class="mt-6 text-lg font-medium leading-relaxed text-gray-900">Rozia International Convention Centre
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flow-root mt-12 sm:mt-16">
                <div class="divide-y divide-gray--200 -my-9">
                    <div class="py-9">
                        <p class="text-xl font-semibold text-black">Who can benefit from the Global Career Carnival 2025?</p>
                        <p class="mt-3 text-base text-gray-600">The event is designed for students, career aspirants, educators, institutions, and industry professionals looking for expert career guidance, mentorship, and networking opportunities.</p>
                    </div>
    
                    <div class="py-9">
                        <p class="text-xl font-semibold text-black">What can I expect from the career guidance sessions?</p>
                        <p class="mt-3 text-base text-gray-600">Career guidance sessions feature top industry professionals sharing insights on various career paths, industry trends, and skill-building strategies to help you make informed career decisions.</p>
                    </div>
    
                    <div class="py-9">
                        <p class="text-xl font-semibold text-black">Are there opportunities for one-on-one mentorship?</p>
                        <p class="mt-3 text-base text-gray-600">Yes! The event offers dedicated mentorship sessions where attendees can connect with professionals for personalized career advice and guidance.</p>
                    </div>
    
                    <div class="py-9">
                        <p class="text-xl font-semibold text-black">What kind of exhibitor stalls will be available?</p>
                        <p class="mt-3 text-base text-gray-600">
                            Leading universities, training institutions, and top companies will have exhibitor stalls showcasing career programs, scholarships, and job opportunities for attendees.
                        </p>
                    </div>
                </div>
            </div>
